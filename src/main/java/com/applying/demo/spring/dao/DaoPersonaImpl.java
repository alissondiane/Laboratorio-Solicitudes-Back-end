	...
	public String agregarPersona(PersonaBean persona) throws SQLException{
		...
		if(cn != null){
            try{
                ...
                cs.setString(4, persona.getUsuario());
                cs.setString(5,persona.getContrasena());
	...
	public String modificarPersona(PersonaBean objPersonaBean) throws Exception {
        ...
        if(cn != null){
            try{
                ...
                cs.setString(5,objPersonaBean.getUsuario());
                cs.setString(6,objPersonaBean.getContrasena());
