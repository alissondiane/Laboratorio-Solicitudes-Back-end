...
public class ResultMessage {
	...
	public ResultMessage(SucessMessageEnumPersona messageConstants, String message ) {
		this.code=messageConstants.idMessage();
		this.message=message;
		this.type=messageConstants.getTypeMessage();
	}
	public ResultMessage(SucessMessageEnumInstitucion messageConstants, String message ) {
		this.code=messageConstants.idMessage();
		this.message=message;
		this.type=messageConstants.getTypeMessage();
	}
